# Con una pantalla LCD vamos a mostra texto en ella, para ello necesitamos descaggar ciertas librerias para poder detectar la pantalla y mostrar el mensaje. 
